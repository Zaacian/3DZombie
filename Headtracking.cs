...
public class Headtracking : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        cameraObject.transform.localPosition = new Vector3(-1.191f - xAverage, 1.865f - yAverage, cameraPos.z);
        cameraObject.transform.eulerAngles = new Vector3(0 - xAverage * 10, -130.3f - yAverage * 10, 0);
